...
abstract contract LiquidityManagerRole is Ownable, TokenReceivable {
  ...
  /**
    ...
    constructor (address _liquidityManager, address _liquidityManagerBot, address _withdrawalAddress) {
        ...
        require(_withdrawalAddress != address(0), "FM: Bad withdrawal address");
